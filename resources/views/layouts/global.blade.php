    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-text mx-3">Ahfas<sup>Test</sup></div>
            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img src="{{ asset('storage/' . Auth::user()->avatar) }}"
                                    class="img-profile rounded-circle" alt="User Foto" style="object-fit: cover">
                                @else
                                <img src="https://source.unsplash.com/QAB-WJcbgJk/60x60"
                                    class="img-profile rounded-circle" alt="User Foto">
                                @endif
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; <strong>Ahfasxp</strong> 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="user" action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Masukan Avatar (optional)</label>
                            <input type="file" class="form-control" name="avatar" placeholder="Masukan Email">
                        </div>
